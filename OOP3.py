...
class Employee:
    ...
    #when we do not have to make any changes in neither the variables of class nor instance,we use static method
    #in these type of functions we dont have to pass "cls" or "self" as the parameters as they are independent
    @staticmethod
    def is_open(day):
        if day=="sunday":
            return False
